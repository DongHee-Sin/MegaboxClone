...
class MainContainerVC: UIViewController {
    ...
    func createCompositionalLayout() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout {
            ...
            // 그룹 사이즈
            let groubSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.9), heightDimension: .fractionalWidth(9/12))
    ...
    func createCompositionalLayout2() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout {
            ...
            // absolute: 고정값, estimateed: 추측, fraction: 퍼센트(내 화면에서 얼마만큼 설정할건가.. 뭐 그런거)
            // fraction은 상위View를 기준으로 퍼센트 잡는듯 (ex- 아이템은 그룹 사이즈를 기준으로 % 잡는듯)
            let itemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(326))
            ...
            // 그룹 사이즈
            let groubSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.6), heightDimension: .absolute(326))
